...
export default class Wave extends Object3DBase {
    ...
    constructor() {
        ...
        const randomUVs = new Float32Array(geometry.attributes.position.count * 2); 
        ...
        geometry.setAttribute('randomUV', new Float32BufferAttribute(randomUVs, 2));
    ...
    public override update(dt: number): void {
        ...
        this._material.uniforms.ratio.value = window.innerWidth/window.innerHeight;
        this._shaderMousePosX += (this._mousePosX - this._shaderMousePosX) * 0.02; 
        this._shaderMousePosY += (this._mousePosY - this._shaderMousePosY) * 0.02; 
        // this._material.updateMousePosition(ThreeMouseManager.RelativeMouseX,-ThreeMouseManager.RelativeMouseY);
        this._material.updateMousePosition(this._shaderMousePosX, this._shaderMousePosY);
